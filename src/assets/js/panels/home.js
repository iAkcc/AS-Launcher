...
class Home {
        ...
        if (news) {
            ...
            blockNews.innerHTML = `
                <div class="news-header">
                    ...
                    <div class="news-content">
                        <div class="bbWrapper">
                            <p>No se puede contactar con el servidor de noticias. Por favor verifique su configuración.</p>
                        </div>
                    </div>`
            newsElement.appendChild(blockNews);
        }
    ...
    async startGame() {
        ...
        let configClient = await this.db.readData('configClient')
        let instances = await config.getInstanceList() // Renombrada para reflejar que es una lista
